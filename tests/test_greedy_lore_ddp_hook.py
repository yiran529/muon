...
def test_registered_hook_callback_path_avoids_forbidden_synchronization():
    callback_path = (
        ...
        hook_module.GreedyLoreDDPState.preparation_stream,
        hook_module.GreedyLoreDDPState.reconstruction_stream,
        hook_module._record_prepared_tensors_on_stream,
        ...
        hook_module._prepare_compressed_bucket,
        ...
        hook_module._launch_compressed_reconstruction,
