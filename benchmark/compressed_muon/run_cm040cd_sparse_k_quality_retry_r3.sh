...
experiment_id=CM040cd-r3-m003-m004-sparse-k-ef14-muon-ws4-s42
...
cells=(
    CM040d-r3-m004-topk-ef14-muon-gpt130m-ddp-ws4-s42
    CM040c-r3-m003-randk-ef14-muon-gpt130m-ddp-ws4-s42
)
configs=(
